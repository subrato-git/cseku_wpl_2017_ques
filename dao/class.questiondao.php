...
Class QuestionDAO{
	...
	public function updateQuestion($Question){
		...
		$SQL = "UPDATE tbl_question_archive SET Title='".$Question->getTitle()."',CourseID='".$Question->getCourse()."',TermID='".$Question->getTerm()."',SessionID='".$Question->getSession()."',TeacherID='".$Question->getTeacher()."',Type='".$Question->getType()."',Tag='".$Question->getTag()."',QuestionDate='".$Question->getQuestionDate()."', Link = '".$Question->getLink()."', CreatorID='".$Question->getCreator()."' WHERE ID='".$Question->getID()."'";
	...
	public function createQuestion($Question){
		...
		$SQL = "INSERT INTO tbl_question_archive(ID,Title,CourseID,TermID,SessionID,TeacherID,Type,Tag,QuestionDate,Link,CreatorID) VALUES('$ID','$Title','$Course','$Term','$Session','$Teacher','$Type','$Tag','$Question_Date', '$Link', '$creator')";
